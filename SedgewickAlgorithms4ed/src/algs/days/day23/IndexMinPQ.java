...
/**
 * For the first time we now have a Priority Queue for which we can alter the priority
 * of an existing member in the PQ, AS LONG AS YOU ONLY DECREASE ITS PRIORITY.
 * 
 * In addition, this Priority Queue only deals with integers in the range from 0 to N-1.
 * 
 * This structure helps the efficiency of any number of graph algorithms, including Dijsktra's 
...
public class IndexMinPQ<Key extends Comparable<Key>> {
	...
	public int delMin() { 
		...
		pq[N+1] = -1;            // not needed; helps with debugging
		return min; 
	}
